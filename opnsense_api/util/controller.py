...
class OPNSenseAPIController:
    ...
    def _format_request(self, command: str, uuid: Optional[str] = None,
        ...
        if uuid is not None:
            base_request = f"{base_request}/{uuid}"
    ...
    def _api_request(self, method: str, command: str, uuid: Optional[str] = None,
    ...
    def _api_get(self, command: str, uuid: Optional[str] = None, params: Optional[dict] = None,
                 body: Optional[dict] = None):
        return self._api_request("GET", command, uuid, params, body)

    def _api_post(self, command: str, uuid: Optional[str] = None, params: Optional[dict] = None,
                  body: Optional[dict] = None):
        return self._api_request("POST", command, uuid, params, body)

    def _api_put(self, command: str, uuid: Optional[str] = None, params: Optional[dict] = None,
                 body: Optional[dict] = None):
        return self._api_request("PUT", command, uuid, params, body)

    def _api_delete(self, command: str, uuid: Optional[str] = None, params: Optional[dict] = None,
                    body: Optional[dict] = None):
